  ...
  return (
    <Dialog open onOpenChange={(open) => !open && onClose()}>
      ...
      >
        ...
        {/* Header */}
        <div
          className="px-4 sm:px-6 py-4 sm:py-5 flex items-start justify-between bg-[#f8faff] sticky top-0 z-10"
        ...
        >
          <div className="flex-1 min-w-0 pr-2">
            ...
            <p
              className="text-xs sm:text-sm mt-0.5 font-mono"
              style={{ color: "#9ca3af" }}
            >
              Code: {item.code}
            </p>
          ...
          <Button
            ...
            size="icon"
            onClick={onClose}
            className="w-8 h-8 rounded-lg flex items-center justify-center hover:bg-[#f1f5f9] shrink-0"
            style={{ color: "#6b7280" }}
          >
        ...
        <div className="p-4 sm:p-6 space-y-4 sm:space-y-5">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p
                ...
                style={{ color: "#9ca3af" }}
              >
                Base Price: {formatCurrency(item.product.price, "NPR")}
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              <p
                className="text-[10px] sm:text-xs uppercase tracking-widest font-bold mb-1.5 sm:mb-2"
                style={{ color: "#9ca3af" }}
              >
                Total Orders
              </p>
            ...
            <div
              className="rounded-xl p-4 sm:p-5 col-span-2 flex flex-col items-center justify-center text-center text-white"
              style={{
                background: "linear-gradient(135deg, #10b981 0%, #15803d 100%)",
                boxShadow: "0 4px 12px rgba(22, 163, 74, 0.2)",
              }}
            >
              <p className="text-[10px] sm:text-xs uppercase tracking-widest font-bold mb-1 sm:mb-1.5 opacity-90">
                Total Earned
              </p>
              <p
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <div
              className="flex-1 rounded-xl p-3 sm:p-4 flex flex-col justify-center"
              style={{ background: "#f8faff" }}
            >
              <div className="flex items-center gap-2 mb-1.5 sm:mb-2">
                <Calendar
              ...
              >
                {item.lastCompletedOrderDate
                  ? formatRelative(
                      new Date(item.lastCompletedOrderDate),
                      new Date(),
                    )
                  : "—"}
              </p>
            ...
            <div
              className="flex-1 rounded-xl p-3 sm:p-4 flex items-center justify-between sm:flex-col sm:items-start sm:justify-center gap-2"
              style={{ background: "#f8faff" }}
            >
              <div>
                <p
                  className="text-[10px] sm:text-xs uppercase tracking-widest font-bold mb-1.5"
                  style={{ color: "#9ca3af" }}
                >
                  Status
                </p>
        ...
        <div
          className="px-4 sm:px-6 pb-4 sm:pb-6 sticky bottom-0 bg-white"
...
export default function EarningsPage() {
  ...
  useEffect(() => {
    ...
    const newUrl = params.toString()
      ? `/dashboard/earnings?${params.toString()}`
      : "/dashboard/earnings";
  ...
  const statCards: StatCardData[] = [
    {
      ...
      value: summaryData
        ? formatCurrency(summaryData.totalCommission, "NPR")
        : "—",
      icon: <DollarSign />,
      iconBg: "#eef2ff",
      iconColor: "#2b4bb9",
  ...
  return (
    ...
    >
      <Topbar
        title="Earnings"
        description="Track your affiliate commission and performance"
      />

      <div className="flex-1 p-4 md:p-8 space-y-4 md:space-y-6 max-w-screen-2xl mx-auto w-full">
        {/* Stat cards */}
        <StatsCards stats={statCards} isLoading={summaryLoading} columns={4} />
        ...
        >
          <div
            className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 px-4 sm:px-6 py-4 sm:py-5"
            style={{ borderBottom: "1px solid #f8faff", background: "#fff" }}
          >
            <div>
              ...
              <div className="flex items-center gap-2 w-full sm:w-auto">
                ...
                >
                  ...
                  <SelectContent className="rounded-xl border-[#f1f5f9] shadow-lg">
                    <SelectItem value="totalCommission" className="font-medium">
                      Total Earned
                    </SelectItem>
                    <SelectItem value="orderCount" className="font-medium">
                      Orders
                    </SelectItem>
                    <SelectItem value="lastOrderDate" className="font-medium">
                      Last Completed
                    </SelectItem>
                    <SelectItem value="code" className="font-medium">
                      Code
                    </SelectItem>
                  </SelectContent>
                </Select>
